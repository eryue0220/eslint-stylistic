...
## [5.0.0-beta.4](https://github.com/eryue0220/eslint-stylistic/compare/v5.0.0-beta.3...v5.0.0-beta.4) (2025-06-12)


### ⚠ BREAKING CHANGES

* handle TS object-like nodes in `object-curly-spacing` instead of `block-spacing` ([#822](https://github.com/eryue0220/eslint-stylistic/issues/822))
* **space-before-function-paren:** handle catch clause with param ([#821](https://github.com/eryue0220/eslint-stylistic/issues/821))
* **object-property-newline:** remove deprecated option ([#809](https://github.com/eryue0220/eslint-stylistic/issues/809))
* v5: remove sub packages ([#794](https://github.com/eryue0220/eslint-stylistic/issues/794))
* migrate to ESM-only, requires ESLint v9+ ([#670](https://github.com/eryue0220/eslint-stylistic/issues/670))
* **indent-binary-ops:** remove unnecessary logic ([#645](https://github.com/eryue0220/eslint-stylistic/issues/645))
* cross test `function-call-spacing` ([#565](https://github.com/eryue0220/eslint-stylistic/issues/565))
* **comma-style:** turn off all exceptions option by default ([#602](https://github.com/eryue0220/eslint-stylistic/issues/602))
* requires Node `^18.18.0 || ^20.9.0 || >=21.1.0`, bump deps ([#337](https://github.com/eryue0220/eslint-stylistic/issues/337))

### Features

* add `module.exports` named export for `require(esm)` compatibility ([#700](https://github.com/eryue0220/eslint-stylistic/issues/700)) ([668c955](https://github.com/eryue0220/eslint-stylistic/commit/668c9556212423702dad4b73685c2299ece2527a))
* add indent option tabLength to customize config ([#538](https://github.com/eryue0220/eslint-stylistic/issues/538)) ([91a18e7](https://github.com/eryue0220/eslint-stylistic/commit/91a18e7a1af7f46c0a125e93c68ac7bc5004d74d))
* bump `[@typescript-eslint](https://github.com/typescript-eslint)` to v8 ([#452](https://github.com/eryue0220/eslint-stylistic/issues/452)) ([27d6b00](https://github.com/eryue0220/eslint-stylistic/commit/27d6b0012801e472a26095708839b37d1e2b4a61))
* **comma-dangle:** add support for Import Attributes ([#586](https://github.com/eryue0220/eslint-stylistic/issues/586)) ([4c177c3](https://github.com/eryue0220/eslint-stylistic/commit/4c177c35057652e3872f65756fa62dc05b34cf93))
* **comma-style:** add support for more syntax ([#597](https://github.com/eryue0220/eslint-stylistic/issues/597)) ([922151c](https://github.com/eryue0220/eslint-stylistic/commit/922151c98b2dc75ad4a135f082050b9dd1b26d11))
* **comma-style:** turn off all exceptions option by default ([#602](https://github.com/eryue0220/eslint-stylistic/issues/602)) ([c424d63](https://github.com/eryue0220/eslint-stylistic/commit/c424d63eda46bc471d871d699b375d84ff3262bb))
* **configs:** add new severity option for all rules ([#733](https://github.com/eryue0220/eslint-stylistic/issues/733)) ([#736](https://github.com/eryue0220/eslint-stylistic/issues/736)) ([c553a9c](https://github.com/eryue0220/eslint-stylistic/commit/c553a9ca745b8a46f1fc41986cde43da2d016431))
* **config:** update `yield-star-spacing` and `generator-star-spacing` config to align with Prettier ([86d17c8](https://github.com/eryue0220/eslint-stylistic/commit/86d17c808df86abd89549b3554b793f71903d27b))
* cross test `comma-spacing` ([#562](https://github.com/eryue0220/eslint-stylistic/issues/562)) ([ea72317](https://github.com/eryue0220/eslint-stylistic/commit/ea72317f548bf6904d10d7f415ce38dc04e454ff))
* cross test `function-call-spacing` ([#565](https://github.com/eryue0220/eslint-stylistic/issues/565)) ([80ec2e4](https://github.com/eryue0220/eslint-stylistic/commit/80ec2e4e3dc5c06e4c0837ac38b41bfad337bfe6))
* **curly-newline:** add new rule ([#548](https://github.com/eryue0220/eslint-stylistic/issues/548)) ([049c20e](https://github.com/eryue0220/eslint-stylistic/commit/049c20e409eb69b19e2fa7434ca5b13276d8adf5))
* deprecate sub packages and emit warnings ([#793](https://github.com/eryue0220/eslint-stylistic/issues/793)) ([48503aa](https://github.com/eryue0220/eslint-stylistic/commit/48503aa38a932aedbcbe9e2b0003f477c0385286))
* **function-call-argument-newline:** add support for Import Attributes ([#603](https://github.com/eryue0220/eslint-stylistic/issues/603)) ([8ee0c24](https://github.com/eryue0220/eslint-stylistic/commit/8ee0c24da827c36da3df2e9724744b88fc3aa988))
* **function-call-spacing:** add `optionalChain` to control the space around the `optional chain` ([#605](https://github.com/eryue0220/eslint-stylistic/issues/605)) ([f732798](https://github.com/eryue0220/eslint-stylistic/commit/f73279887c755db71e47cb3248fea746fb34e783))
* **function-call-spacing:** auto-fix optional chain when option is `never` ([#589](https://github.com/eryue0220/eslint-stylistic/issues/589)) ([7a2b47f](https://github.com/eryue0220/eslint-stylistic/commit/7a2b47f9cfa32e311eea5b16b3a26c9d034f60df))
* **function-call-spacing:** support `ImportExpression` in `ts` version ([#570](https://github.com/eryue0220/eslint-stylistic/issues/570)) ([19d1f8c](https://github.com/eryue0220/eslint-stylistic/commit/19d1f8c4a4ae674c53adb4c908bd82985f9af6b9))
* **function-paren-newline:** add support for Import Attributes ([#585](https://github.com/eryue0220/eslint-stylistic/issues/585)) ([4ede153](https://github.com/eryue0220/eslint-stylistic/commit/4ede153af46af01ed3250e16365975e034631455))
* **generic-spacing:** remove spaces in type param instantiation ([#677](https://github.com/eryue0220/eslint-stylistic/issues/677)) ([2a29e28](https://github.com/eryue0220/eslint-stylistic/commit/2a29e2820116c5e728de9f15f324677e4240d25f))
* handle TS object-like nodes in `object-curly-spacing` instead of `block-spacing` ([#822](https://github.com/eryue0220/eslint-stylistic/issues/822)) ([e9a4b80](https://github.com/eryue0220/eslint-stylistic/commit/e9a4b80cc014be3df7141e0e005b284832126b44))
* Improve indent in template literals ([#553](https://github.com/eryue0220/eslint-stylistic/issues/553)) ([9130c94](https://github.com/eryue0220/eslint-stylistic/commit/9130c94eff8a0c97dbee2057c4e9b5891339ce44))
* **indent-binary-ops:** disabled to lower indent when starts closing bracket ([#591](https://github.com/eryue0220/eslint-stylistic/issues/591)) ([25fe554](https://github.com/eryue0220/eslint-stylistic/commit/25fe554cc19e0193e973dd4dd48ed5e218b5c6a5))
* **indent-binary-ops:** logical expression indent ([#576](https://github.com/eryue0220/eslint-stylistic/issues/576)) ([cbf800d](https://github.com/eryue0220/eslint-stylistic/commit/cbf800ddebf04b2439a751a5d773b80c498f504e))
* **indent:** add support for Import Attributes ([#579](https://github.com/eryue0220/eslint-stylistic/issues/579)) ([4f944d8](https://github.com/eryue0220/eslint-stylistic/commit/4f944d803f779194d76bbd8d9308cef2fb22d7ec))
* **indent:** indention inside TemplateLiteral always start at level one ([#528](https://github.com/eryue0220/eslint-stylistic/issues/528)) ([d2f92c0](https://github.com/eryue0220/eslint-stylistic/commit/d2f92c0a04292b05ddbc785c7803be8f94935f80))
* **indent:** introduce `offsetTernaryExpressionsOffsetCallExpressions` options ([#636](https://github.com/eryue0220/eslint-stylistic/issues/636)) ([c14a3ee](https://github.com/eryue0220/eslint-stylistic/commit/c14a3eef1898c0ade0952208a4a470a6c6dd091f))
* **indent:** support for JSXText indentation ([#413](https://github.com/eryue0220/eslint-stylistic/issues/413)) ([a5b62a0](https://github.com/eryue0220/eslint-stylistic/commit/a5b62a04d3b25d6144a5935f0ed9370487f26409))
* **js/array-element-newline:** options multiline and consistent combination ([#445](https://github.com/eryue0220/eslint-stylistic/issues/445)) ([cfd3327](https://github.com/eryue0220/eslint-stylistic/commit/cfd332766de15e9ab29e92c5048640a07f2f15bd))
* **js:** add option `ignoreStringLiterals` ([#401](https://github.com/eryue0220/eslint-stylistic/issues/401)) ([1b6d563](https://github.com/eryue0220/eslint-stylistic/commit/1b6d563921b408723fa9a5bd911f5890c698f649)), closes [#400](https://github.com/eryue0220/eslint-stylistic/issues/400)
* **js:** port `multiline-comment-style` and `line-comment-position` ([#389](https://github.com/eryue0220/eslint-stylistic/issues/389)) ([e3212fe](https://github.com/eryue0220/eslint-stylistic/commit/e3212fe2e9daca4e1be69751654eb3c0c1176929))
* **jsx-function-call-newline:** add jsx-function-call-newline rule ([#376](https://github.com/eryue0220/eslint-stylistic/issues/376)) ([110aa4c](https://github.com/eryue0220/eslint-stylistic/commit/110aa4ccc33371e47943952e1b595d67239ef5dc))
* **jsx-one-expression-per-line:** allow `non-jsx` ([#393](https://github.com/eryue0220/eslint-stylistic/issues/393)) ([431d564](https://github.com/eryue0220/eslint-stylistic/commit/431d56475af2ba183421cb051e486b2bb6940169))
* **jsx-one-expression-per-line:** allow single line ([#377](https://github.com/eryue0220/eslint-stylistic/issues/377)) ([f8825f2](https://github.com/eryue0220/eslint-stylistic/commit/f8825f290cd049c07f17dd2fea16ffec6e532e39))
* **jsx-sort-props:** support custom reservedFirst and reservedLast ([#744](https://github.com/eryue0220/eslint-stylistic/issues/744)) ([fb17e96](https://github.com/eryue0220/eslint-stylistic/commit/fb17e9635a39873452a82e9e186af11966db679f))
* **jsx-wrap-multilines:** supports adding parentheses and line breaks for object properties ([#372](https://github.com/eryue0220/eslint-stylistic/issues/372)) ([c72d043](https://github.com/eryue0220/eslint-stylistic/commit/c72d0437e4cf447918b0750200cf8fb6a46af2cf))
* **jsx/jsx-closing-tag-location:** add location option to customize indentation ([#550](https://github.com/eryue0220/eslint-stylistic/issues/550)) ([ae09edd](https://github.com/eryue0220/eslint-stylistic/commit/ae09edda14304e85df1426a7eb79e68d4fd029ba))
* **key-spacing:** add ignoredNodes option ([#640](https://github.com/eryue0220/eslint-stylistic/issues/640)) ([33ae1f6](https://github.com/eryue0220/eslint-stylistic/commit/33ae1f6fbeb15f36967998fe566b74df7db8d3d5))
* **key-spacing:** add support for Import Attributes ([#583](https://github.com/eryue0220/eslint-stylistic/issues/583)) ([789d893](https://github.com/eryue0220/eslint-stylistic/commit/789d8935de1f05c6f525017bbb55b2729cff55b2))
* **max-statements-per-line:** new option to allow specific statements ([#558](https://github.com/eryue0220/eslint-stylistic/issues/558)) ([2ed4054](https://github.com/eryue0220/eslint-stylistic/commit/2ed405430c52ee13b5eaf2754e7c6c178d4e79e5))
* migrate to `@types/eslint` `v9.6.0` ([#479](https://github.com/eryue0220/eslint-stylistic/issues/479)) ([ea72aae](https://github.com/eryue0220/eslint-stylistic/commit/ea72aaedc94c8178aa338f563b717f33ffc713f7))
* migrate to ESM-only, requires ESLint v9+ ([#670](https://github.com/eryue0220/eslint-stylistic/issues/670)) ([3145d50](https://github.com/eryue0220/eslint-stylistic/commit/3145d5082191505f319e576cc30da51b907c380e))
* **no-extra-parens:** allow spread syntax to wrap parentheses ([#781](https://github.com/eryue0220/eslint-stylistic/issues/781)) ([bc74e90](https://github.com/eryue0220/eslint-stylistic/commit/bc74e9081b06a6ee2e695b1016b35289f0941976))
* **no-extra-parens:** introduce `nestedConditionalExpressions` option ([#657](https://github.com/eryue0220/eslint-stylistic/issues/657)) ([bf63800](https://github.com/eryue0220/eslint-stylistic/commit/bf63800c49218d554c79b4da6513c8ef90f59857))
* **no-multi-spaces:** add support for Import Attributes ([#584](https://github.com/eryue0220/eslint-stylistic/issues/584)) ([0da0713](https://github.com/eryue0220/eslint-stylistic/commit/0da07139a6c8e65d0478db91b534498d9a6c9889))
* **object-property-newline:** remove deprecated option ([#809](https://github.com/eryue0220/eslint-stylistic/issues/809)) ([30614af](https://github.com/eryue0220/eslint-stylistic/commit/30614af0e865c3dd6ff0c1d8d9d8407619d4d263))
* **operator-linebreak:** support TS Nodes ([#805](https://github.com/eryue0220/eslint-stylistic/issues/805)) ([d7ab8d2](https://github.com/eryue0220/eslint-stylistic/commit/d7ab8d226dcf8a3962c91d036ead4dbfc33c7e99))
* **padded-blocks:** add start and end options ([#655](https://github.com/eryue0220/eslint-stylistic/issues/655)) ([cf49939](https://github.com/eryue0220/eslint-stylistic/commit/cf49939a716a8f66f2d5be1d043a7c736133a986))
* **padding-line-between-statements:** add support for multiline-export and singleline-export ([#582](https://github.com/eryue0220/eslint-stylistic/issues/582)) ([2690a30](https://github.com/eryue0220/eslint-stylistic/commit/2690a302d50b044a58f7143fd26cb4204ab7e19d))
* **quote-props:** add support for Import Attributes ([#581](https://github.com/eryue0220/eslint-stylistic/issues/581)) ([4edfee2](https://github.com/eryue0220/eslint-stylistic/commit/4edfee2c573214b8feec1e1f1c06835e5cdb626c))
* **quotes:** Option to allow template literals only to avoid escape ([#643](https://github.com/eryue0220/eslint-stylistic/issues/643)) ([5558bdb](https://github.com/eryue0220/eslint-stylistic/commit/5558bdbb2eb989b81bf7b91c62d5e9f1c80bb822))
* remove `@types/eslint` ([5ea3d6a](https://github.com/eryue0220/eslint-stylistic/commit/5ea3d6ac78ffd269a14bb86b848b1b4a3c8ca1d1))
* requires Node `^18.18.0 || ^20.9.0 || >=21.1.0`, bump deps ([#337](https://github.com/eryue0220/eslint-stylistic/issues/337)) ([300ce2c](https://github.com/eryue0220/eslint-stylistic/commit/300ce2cdf3154dcfd139e60546234ec8fd2620d2))
* **semi-spacing:** support handling typescript ([#687](https://github.com/eryue0220/eslint-stylistic/issues/687)) ([8b76c93](https://github.com/eryue0220/eslint-stylistic/commit/8b76c931178b705523bb130eb2d8e154071ea7ff))
* **space-before-function-paren:** handle catch clause with param ([#821](https://github.com/eryue0220/eslint-stylistic/issues/821)) ([64c0607](https://github.com/eryue0220/eslint-stylistic/commit/64c0607767a4a5022d8ce3a5b5bb346c48ec5dd4))
* **space-infix-ops:** allow to ignore types in ts variant ([#684](https://github.com/eryue0220/eslint-stylistic/issues/684)) ([c83ce20](https://github.com/eryue0220/eslint-stylistic/commit/c83ce20633966e6abfc181ee667ff4a9ea7d8c79))
* **ts:** add `object-curly-newline` and `object-property-newline` ([#444](https://github.com/eryue0220/eslint-stylistic/issues/444)) ([036d3de](https://github.com/eryue0220/eslint-stylistic/commit/036d3de3a02e86dde21b01369f98521571cd4273))
* **type-generic-spacing:** remove whitespaces in generic types ([#667](https://github.com/eryue0220/eslint-stylistic/issues/667)) ([8dd68e2](https://github.com/eryue0220/eslint-stylistic/commit/8dd68e2c7dd6720ce2c0e6fcdbe9c0573c3a1eda))
* v5: remove sub packages ([#794](https://github.com/eryue0220/eslint-stylistic/issues/794)) ([3b2fd6e](https://github.com/eryue0220/eslint-stylistic/commit/3b2fd6e09650aefc96ba7a8006012eac9a75d96f))


### Bug Fixes

* add explicit `"type": "commonjs"` ([9d37124](https://github.com/eryue0220/eslint-stylistic/commit/9d37124f9b5374c76d5a178928cb350b110dcfce))
* **arrow-parens:** wrong parens removal with optional parameter ([#499](https://github.com/eryue0220/eslint-stylistic/issues/499)) ([71896ce](https://github.com/eryue0220/eslint-stylistic/commit/71896ce0395f810d96e643f47e98ef3812a6dc05))
* **comma-style:** handles comma after default import and trailing comma ([#600](https://github.com/eryue0220/eslint-stylistic/issues/600)) ([2d8d8ce](https://github.com/eryue0220/eslint-stylistic/commit/2d8d8ce57a12b597de1cffab8e9784b8e20fca15))
* compatible with ts-eslint v7, close [#484](https://github.com/eryue0220/eslint-stylistic/issues/484) ([c312fc7](https://github.com/eryue0220/eslint-stylistic/commit/c312fc7a8b232353bd38b2ab0d2665a4f7851de5))
* **configs:** should not ignore `templateLiteral` for `indent` ([3154799](https://github.com/eryue0220/eslint-stylistic/commit/3154799d2dec1aab326ce787e2da233696e451b6))
* correct the type of `quotes` in `customize` ([#590](https://github.com/eryue0220/eslint-stylistic/issues/590)) ([b86c2df](https://github.com/eryue0220/eslint-stylistic/commit/b86c2df9a4700bbe37dd2fbb6fe45dba904895f7))
* **deps:** unpin typescript-eslint deps ([#673](https://github.com/eryue0220/eslint-stylistic/issues/673)) ([9fb672d](https://github.com/eryue0220/eslint-stylistic/commit/9fb672df83c5138a3f521f281e37babb307606bc))
* **eslint-plugin:** only export interfaces in index ([#763](https://github.com/eryue0220/eslint-stylistic/issues/763)) ([93a4eb1](https://github.com/eryue0220/eslint-stylistic/commit/93a4eb1a55615dce0cf86f3124ac6aa891b5bd8a))
* fix the `update` script in `Windows` ([#604](https://github.com/eryue0220/eslint-stylistic/issues/604)) ([dede119](https://github.com/eryue0220/eslint-stylistic/commit/dede11938e3e15a9e36efefeb548eaa1f3cb1484))
* **function-call-spacing:** don't remove comments while auto-fixing ([#588](https://github.com/eryue0220/eslint-stylistic/issues/588)) ([53b4a55](https://github.com/eryue0220/eslint-stylistic/commit/53b4a55b6ddca27e8f1cebf90a8835dc383fd07b))
* **function-call-spacing:** remove invalid defaults from schema ([#617](https://github.com/eryue0220/eslint-stylistic/issues/617)) ([0714754](https://github.com/eryue0220/eslint-stylistic/commit/07147543dad01ecdf99ebb17b00384f134926bc5))
* handle new AST change on `TSImportType` ([8f31461](https://github.com/eryue0220/eslint-stylistic/commit/8f31461f22f6d59836705ddeb5713129b118d50c))
* **indent-binary-ops:** correctly handle `TypeAliasDeclaration` ([#647](https://github.com/eryue0220/eslint-stylistic/issues/647)) ([ca2aabc](https://github.com/eryue0220/eslint-stylistic/commit/ca2aabc52a9d219cd16889cc9c4ea8b04d6af054))
* **indent-binary-ops:** handle `{` for left token check ([#693](https://github.com/eryue0220/eslint-stylistic/issues/693)) ([7f2740e](https://github.com/eryue0220/eslint-stylistic/commit/7f2740e824b621c07fe373f81bdd7dac093f2422))
* **indent-binary-ops:** improve nested handling, close [#530](https://github.com/eryue0220/eslint-stylistic/issues/530) ([af1c21a](https://github.com/eryue0220/eslint-stylistic/commit/af1c21a4666e3a3d927c05f5f977a37c1477640a))
* **indent-binary-ops:** indent on multiline assignment ([#644](https://github.com/eryue0220/eslint-stylistic/issues/644)) ([d708587](https://github.com/eryue0220/eslint-stylistic/commit/d7085874e84d7113a140878650f90f4efae87766))
* **indent:** consider `CallExpression` when `offsetTernaryExpressions` is true ([#625](https://github.com/eryue0220/eslint-stylistic/issues/625)) ([55d3529](https://github.com/eryue0220/eslint-stylistic/commit/55d3529bd8da0d5d944e0647713a8afa17296639))
* **indent:** correct class property initialization ([#431](https://github.com/eryue0220/eslint-stylistic/issues/431)) ([09ea5b0](https://github.com/eryue0220/eslint-stylistic/commit/09ea5b0fdccc3f8585cfaf574914f4f9c2109d5d))
* **indent:** correct indentation for `PropertyDefinition` with decorators ([#416](https://github.com/eryue0220/eslint-stylistic/issues/416)) ([4b4d27c](https://github.com/eryue0220/eslint-stylistic/commit/4b4d27c0ede2bada33aab5cb9fcdca7e77448b8a))
* **indent:** correct indentation in chained methods calls with generics ([#424](https://github.com/eryue0220/eslint-stylistic/issues/424)) ([4ba8b08](https://github.com/eryue0220/eslint-stylistic/commit/4ba8b0866e602dd416d367d6435c747d594bbe97))
* **indent:** correctly ignore `JSXText` and TS nodes ([#785](https://github.com/eryue0220/eslint-stylistic/issues/785)) ([b0b4218](https://github.com/eryue0220/eslint-stylistic/commit/b0b4218a4534ea14ea458f50fde2665f1a5757a7))
* **indent:** handle `ChainExpression` and `AwaitExpression` when `offsetTernaryExpressionsOffsetCallExpressions` ([#751](https://github.com/eryue0220/eslint-stylistic/issues/751)) ([a1af663](https://github.com/eryue0220/eslint-stylistic/commit/a1af6635dce41dbea7ae7abcae037e40dee667b7))
* **indent:** handle mixed spaces and tabs ([#465](https://github.com/eryue0220/eslint-stylistic/issues/465)) ([d5ae88d](https://github.com/eryue0220/eslint-stylistic/commit/d5ae88d6602f0e506872d06ef3dd1b4e6443638e))
* **indent:** handle undefined `node.decorators` when tsParser is not configured ([#422](https://github.com/eryue0220/eslint-stylistic/issues/422)) ([3d63054](https://github.com/eryue0220/eslint-stylistic/commit/3d63054ca962a00cdc5a3b4406daac97e7b94371))
* **indent:** indentation for argument with decorators ([#487](https://github.com/eryue0220/eslint-stylistic/issues/487)) ([aefb3be](https://github.com/eryue0220/eslint-stylistic/commit/aefb3be36e53857e8ce7fb1a0d629d1dab11979b))
* **indent:** wrong PropertyDefinition value offset when ts type have multiple line ([#774](https://github.com/eryue0220/eslint-stylistic/issues/774)) ([140e18f](https://github.com/eryue0220/eslint-stylistic/commit/140e18f3fc18a99e3e38f05d99eea6776b284938))
* **jsx-closing-bracket-location:** should not remove comment in jsx ([#566](https://github.com/eryue0220/eslint-stylistic/issues/566)) ([e2ba8d5](https://github.com/eryue0220/eslint-stylistic/commit/e2ba8d535884a4f997f22b42be0c3f5c0d4f1c64))
* **jsx-indent:** conflict between indent and jsx-indent ([#368](https://github.com/eryue0220/eslint-stylistic/issues/368)) ([7313184](https://github.com/eryue0220/eslint-stylistic/commit/731318474fd5c7b0abe7f21abcb7334949bafc2e))
* **jsx-indent:** deprecate `jsx-indent` rule in favor of `indent` ([#447](https://github.com/eryue0220/eslint-stylistic/issues/447)) ([57dd2e8](https://github.com/eryue0220/eslint-stylistic/commit/57dd2e8b5927e6f9de019fff6e83cac4989de7ce))
* **jsx-one-expression-per-line:** only one line break has not been processed ([#384](https://github.com/eryue0220/eslint-stylistic/issues/384)) ([a297f84](https://github.com/eryue0220/eslint-stylistic/commit/a297f8434894fab99c5a2792477a8f9818aa3031))
* **jsx-sort-props:** correct option schema ([#801](https://github.com/eryue0220/eslint-stylistic/issues/801)) ([f80f38a](https://github.com/eryue0220/eslint-stylistic/commit/f80f38a9d68d9f98b6a32329b94ce8a5f61a58f7))
* **jsx-wrap-multilines:** prevent crash when using tabs ([#653](https://github.com/eryue0220/eslint-stylistic/issues/653)) ([8cbc9f8](https://github.com/eryue0220/eslint-stylistic/commit/8cbc9f85d6b8b75acb3eac6e606d2361cc1d2af6))
* **jsx-wrap-multilines:** text between replacement texts included in parentheses ([#618](https://github.com/eryue0220/eslint-stylistic/issues/618)) ([0764252](https://github.com/eryue0220/eslint-stylistic/commit/07642521b779636a9580d5236a0e03fceaa74d58))
* **key-spacing:** crash for import without attributes when using `align: "colon"` ([#594](https://github.com/eryue0220/eslint-stylistic/issues/594)) ([6000f43](https://github.com/eryue0220/eslint-stylistic/commit/6000f43d0d6522af1616192321a84cb2ead9b95d))
* **keyword-spacing:** check spaces around the `type` keyword in `export` declarations ([#797](https://github.com/eryue0220/eslint-stylistic/issues/797)) ([6854a3c](https://github.com/eryue0220/eslint-stylistic/commit/6854a3c832a35397d1b5a558c85508f6edef18d8))
* **lines-between-class-members:** properly infer `exceptAfterOverload` from `enforce` ([#239](https://github.com/eryue0220/eslint-stylistic/issues/239)) ([3dfa159](https://github.com/eryue0220/eslint-stylistic/commit/3dfa1594c2b9e75e4a4260ca07d5f5c654204d18))
* make plugin assignable to ESLint.Plugin ([#418](https://github.com/eryue0220/eslint-stylistic/issues/418)) ([9887ead](https://github.com/eryue0220/eslint-stylistic/commit/9887ead9ae485fa8393e2f7b529074bf04200867))
* metadata path generate normalize ([#820](https://github.com/eryue0220/eslint-stylistic/issues/820)) ([7c6d6ef](https://github.com/eryue0220/eslint-stylistic/commit/7c6d6ef3a7490dc2fed4345b15d353babc2db704))
* move spacing rules about `as` and `satisfies` from `type-annontation-spacing` to `keyword-spacing` ([#535](https://github.com/eryue0220/eslint-stylistic/issues/535)) ([b89ae5e](https://github.com/eryue0220/eslint-stylistic/commit/b89ae5e8f588fc68d59df7c5d7a14559d878c331))
* **no-extra-parens:** do not break specific `ReturnStatement` ([#738](https://github.com/eryue0220/eslint-stylistic/issues/738)) ([a375a92](https://github.com/eryue0220/eslint-stylistic/commit/a375a92fefe3905ba46961e3278cc80cdf3ba050))
* **plus/indent-binary-ops:** considring `||` and `&&` ([#430](https://github.com/eryue0220/eslint-stylistic/issues/430)) ([9627a10](https://github.com/eryue0220/eslint-stylistic/commit/9627a10af0e873475b0a90fef289a45033370df3))
* **plus:** dependencies bundle ([ba9ed81](https://github.com/eryue0220/eslint-stylistic/commit/ba9ed81029c7cc06a38a36f16faf443138bd4800))
* **quotes:** allow template literals to avoid escape sequences ([#410](https://github.com/eryue0220/eslint-stylistic/issues/410)) ([1891c5f](https://github.com/eryue0220/eslint-stylistic/commit/1891c5fd8ae3580b892694836c2a387070de2084))
* **quotes:** ignore backtick in ts import types ([#493](https://github.com/eryue0220/eslint-stylistic/issues/493)) ([a7f7c2a](https://github.com/eryue0220/eslint-stylistic/commit/a7f7c2a900223570586740763487b674644560e2))
* **quotes:** only when allowTemplateLiterals set, allow template literals to avoid escape sequences ([#544](https://github.com/eryue0220/eslint-stylistic/issues/544)) ([7e3a0d3](https://github.com/eryue0220/eslint-stylistic/commit/7e3a0d3b1989e708e0bad9a6315c4a91c34a4948))
* **ts/padding-line-between-statements:** removing blank line between functions in interface ([#71](https://github.com/eryue0220/eslint-stylistic/issues/71)) ([#468](https://github.com/eryue0220/eslint-stylistic/issues/468)) ([91eb636](https://github.com/eryue0220/eslint-stylistic/commit/91eb636c6eb8e6887ec67fb9ecaa2b24079ef16f))
* **ts:** chunk bundling ([a278468](https://github.com/eryue0220/eslint-stylistic/commit/a27846842778970d2a1d9d91799aec8e233fc840))
* **type-annotation-spacing:** consider spacing around `as` and `satisfies` operator ([#517](https://github.com/eryue0220/eslint-stylistic/issues/517)) ([cf254a9](https://github.com/eryue0220/eslint-stylistic/commit/cf254a9f00d504d2f433a937cfb25003083e2552))
* **type-generic-spacing:** consider parentheses ([#467](https://github.com/eryue0220/eslint-stylistic/issues/467)) ([fd08dd8](https://github.com/eryue0220/eslint-stylistic/commit/fd08dd862081d34094423441115f39d7013b6464))
* **types:** add missing type reference, close [#526](https://github.com/eryue0220/eslint-stylistic/issues/526) ([47fddb0](https://github.com/eryue0220/eslint-stylistic/commit/47fddb0f6ac7f6e45188eff4f28755885e317249))


### Documentation

* add `flat: true` to flat config customize example ([#669](https://github.com/eryue0220/eslint-stylistic/issues/669)) ([4710771](https://github.com/eryue0220/eslint-stylistic/commit/4710771c11548a4b854c89188351d0d4a1b27fd7))
* add flat config versions for Migrate to 1-to-1 Plugins ([#435](https://github.com/eryue0220/eslint-stylistic/issues/435)) ([d670924](https://github.com/eryue0220/eslint-stylistic/commit/d6709241555f6acd34c52325c3a044f32f1b8241))
* cleanup outdated information ([#818](https://github.com/eryue0220/eslint-stylistic/issues/818)) ([33d0edd](https://github.com/eryue0220/eslint-stylistic/commit/33d0edd9dd6576130f1cd3208db8ca88bb56dd64))
* correct eslint flat config in migration guide ([#634](https://github.com/eryue0220/eslint-stylistic/issues/634)) ([16a0ae0](https://github.com/eryue0220/eslint-stylistic/commit/16a0ae0b181230007ca7b80c1eb60b13e79a1ac2))
* deprecate `jsx-indent` ([#741](https://github.com/eryue0220/eslint-stylistic/issues/741)) ([ca23ce1](https://github.com/eryue0220/eslint-stylistic/commit/ca23ce1ef0063f946e4defbf4118edc4eae49748))
* fix "Contributing" link ([#383](https://github.com/eryue0220/eslint-stylistic/issues/383)) ([c89125f](https://github.com/eryue0220/eslint-stylistic/commit/c89125f7e81cfb5ebce37ce65bfdba726456574a))
* fix broken link in ts/lines-between-class-members rule ([#385](https://github.com/eryue0220/eslint-stylistic/issues/385)) ([594a860](https://github.com/eryue0220/eslint-stylistic/commit/594a860b25ae032d11dddf0cf1303d3ee6d3c934))
* fix comment example ([#759](https://github.com/eryue0220/eslint-stylistic/issues/759)) ([c841bb6](https://github.com/eryue0220/eslint-stylistic/commit/c841bb6fe72fd13a1db28e21580a1056036d25fe))
* fix eslint error ([#775](https://github.com/eryue0220/eslint-stylistic/issues/775)) ([f2866f9](https://github.com/eryue0220/eslint-stylistic/commit/f2866f9120fa73c5ed98e501364fdd3948cabd82))
* fix eslint error tip does not display ([#792](https://github.com/eryue0220/eslint-stylistic/issues/792)) ([b09756d](https://github.com/eryue0220/eslint-stylistic/commit/b09756de4061e249dc34c424948be9a53dbed821))
* fix incorrect breadcrumbs ([#642](https://github.com/eryue0220/eslint-stylistic/issues/642)) ([eea9267](https://github.com/eryue0220/eslint-stylistic/commit/eea92676326d26ec3786d2e2ee842507678fb565))
* fix indentation in jsx.md ([#434](https://github.com/eryue0220/eslint-stylistic/issues/434)) ([578fce1](https://github.com/eryue0220/eslint-stylistic/commit/578fce1a7311a5ae25fa4781577b25c3df5b64c7))
* fix link ([#379](https://github.com/eryue0220/eslint-stylistic/issues/379)) ([5060350](https://github.com/eryue0220/eslint-stylistic/commit/5060350fe3ecc3acd7fae83eb45cbd4de9c06fb5))
* fix link to selectors ([#345](https://github.com/eryue0220/eslint-stylistic/issues/345)) ([54bafb7](https://github.com/eryue0220/eslint-stylistic/commit/54bafb76c43bb8e808b5019f5d9e9e8a4e0ee387))
* fix note block display ([#471](https://github.com/eryue0220/eslint-stylistic/issues/471)) ([28db32c](https://github.com/eryue0220/eslint-stylistic/commit/28db32cb894cb1f7a70eaa0ef5f162aaaf1cf08c))
* fix typo in migration.md ([#432](https://github.com/eryue0220/eslint-stylistic/issues/432)) ([fc38d86](https://github.com/eryue0220/eslint-stylistic/commit/fc38d86faa632807aa869f2e2906ea133c487558))
* **func-call-spacing:** fixing broken links ([#587](https://github.com/eryue0220/eslint-stylistic/issues/587)) ([d3dbc22](https://github.com/eryue0220/eslint-stylistic/commit/d3dbc22f89c6cf7c8e54feedb5b73a8b64e145e9))
* improve docs search, close [#381](https://github.com/eryue0220/eslint-stylistic/issues/381) ([d0df679](https://github.com/eryue0220/eslint-stylistic/commit/d0df679403645bfddceb629bb35284bb9ae0a38a))
* incorrect error tip should display ([#747](https://github.com/eryue0220/eslint-stylistic/issues/747)) ([7e06b81](https://github.com/eryue0220/eslint-stylistic/commit/7e06b8118c563e7ab0e7b99bd1f579249e3b5de9))
* **indent:** fix incorrect option description ([#638](https://github.com/eryue0220/eslint-stylistic/issues/638)) ([d427d47](https://github.com/eryue0220/eslint-stylistic/commit/d427d47c430b5d9db90349438eaaa2c30b083511))
* **no-mixed-operators:** clarify rule behavior for parameter 'groups' ([#302](https://github.com/eryue0220/eslint-stylistic/issues/302)) ([cd02cea](https://github.com/eryue0220/eslint-stylistic/commit/cd02cea85ce3cafee1d8bf5f3b4dfa9bee920542))
* redirect curly to eslint page ([#309](https://github.com/eryue0220/eslint-stylistic/issues/309)) ([4d0e78e](https://github.com/eryue0220/eslint-stylistic/commit/4d0e78ecc222d7af39c01fdd95d08d5af7491754))
* redirect rule docs, close [#532](https://github.com/eryue0220/eslint-stylistic/issues/532) ([7b92cfd](https://github.com/eryue0220/eslint-stylistic/commit/7b92cfd6f9de8deeef646112254addabaf54f4d5))
* redirect sub packages links ([#811](https://github.com/eryue0220/eslint-stylistic/issues/811)) ([3a6aff2](https://github.com/eryue0220/eslint-stylistic/commit/3a6aff2ae24c8cc7367f311d008e5dc7e9dc896d))
* remove legacy config option, close [#703](https://github.com/eryue0220/eslint-stylistic/issues/703) ([de8369e](https://github.com/eryue0220/eslint-stylistic/commit/de8369e3d9b85055014562c6055c5bf6e801dba1))
* support eslint v9 parser ([#631](https://github.com/eryue0220/eslint-stylistic/issues/631)) ([0e4b1cb](https://github.com/eryue0220/eslint-stylistic/commit/0e4b1cbd6df7f7ef45f99c5fe4bfc99bb595f009))
* **ts/member-delimiter-style:** fix spaces ([#461](https://github.com/eryue0220/eslint-stylistic/issues/461)) ([240006c](https://github.com/eryue0220/eslint-stylistic/commit/240006cd887de265dc33eb027765846bd877bfd2))
* typo ([#534](https://github.com/eryue0220/eslint-stylistic/issues/534)) ([9573674](https://github.com/eryue0220/eslint-stylistic/commit/9573674cb7a15885255a4c20f0e92a588886fabc))
* typo ([#662](https://github.com/eryue0220/eslint-stylistic/issues/662)) ([a87f5bd](https://github.com/eryue0220/eslint-stylistic/commit/a87f5bd4e6428b5887359b5e793d36fbdd9376a0))
* typo ([#723](https://github.com/eryue0220/eslint-stylistic/issues/723)) ([b6ed751](https://github.com/eryue0220/eslint-stylistic/commit/b6ed75158336a3253378b6312c5311ebbd139bcb))
* update links ([f80db20](https://github.com/eryue0220/eslint-stylistic/commit/f80db20d67d2f796655fd83de370609e21fa701f))
* update merged note ([07b08f1](https://github.com/eryue0220/eslint-stylistic/commit/07b08f1c7d74de0fe2cb6886b4f49baae574a71b))
* update project progress ([#449](https://github.com/eryue0220/eslint-stylistic/issues/449)) ([d6d72c8](https://github.com/eryue0220/eslint-stylistic/commit/d6d72c8975f8a9be0e25dd6c41d03d90b00b2a62))
* update repo url ([618eb66](https://github.com/eryue0220/eslint-stylistic/commit/618eb6614a6d08f694ec61ce62df0f4865285230))
* update repro link ([83e35d1](https://github.com/eryue0220/eslint-stylistic/commit/83e35d13ba0a54ef484e20ac5df143b600d38fd3))
* use new vscode codeActionsOnSave syntax ([#511](https://github.com/eryue0220/eslint-stylistic/issues/511)) ([086b7f3](https://github.com/eryue0220/eslint-stylistic/commit/086b7f342a5cdbd289e2327ddfc3bb71cb51ba62))


### Build Related

* **deps:** bump codecov/codecov-action from 4 to 5 ([#612](https://github.com/eryue0220/eslint-stylistic/issues/612)) ([047a384](https://github.com/eryue0220/eslint-stylistic/commit/047a3840e43bea3731c5bef629e18a06b10c55a8))
* improve bundling ([bb187a8](https://github.com/eryue0220/eslint-stylistic/commit/bb187a85b65d611a985f3b0da0f200d0711a2f6b))
* standalone build for main package ([971b534](https://github.com/eryue0220/eslint-stylistic/commit/971b53481a21ce8aa801d2142c7843e0560e626d))
* try using a single package for release-please ([b3bf006](https://github.com/eryue0220/eslint-stylistic/commit/b3bf006e340a5690479b82f457c4f9826ef24e67))


### Chores

* `comma-dangle` ([#716](https://github.com/eryue0220/eslint-stylistic/issues/716)) ([7e55b16](https://github.com/eryue0220/eslint-stylistic/commit/7e55b1645d228ee7471bfdd71ff92bf9a7a0cd16))
* alias for shared utils ([#510](https://github.com/eryue0220/eslint-stylistic/issues/510)) ([6ea8368](https://github.com/eryue0220/eslint-stylistic/commit/6ea83684cd558a8f9b77c17df31d39d30a669c69))
* consistent `createRule` argument order ([83e22f2](https://github.com/eryue0220/eslint-stylistic/commit/83e22f29e46603d103b50627c34620fa93226583))
* cross test `indent` ([#563](https://github.com/eryue0220/eslint-stylistic/issues/563)) ([80c5486](https://github.com/eryue0220/eslint-stylistic/commit/80c5486682a1ff3ecea525cdf4e3d27d0e2a0bb8))
* cross test merged rules (partial) ([#520](https://github.com/eryue0220/eslint-stylistic/issues/520)) ([97448b9](https://github.com/eryue0220/eslint-stylistic/commit/97448b9648206f0eb2230a17cf08f8014476ae13))
* cross test merged rules (rest)  ([#529](https://github.com/eryue0220/eslint-stylistic/issues/529)) ([e9087d3](https://github.com/eryue0220/eslint-stylistic/commit/e9087d3e5fd9f7966c86091a4349d7244ace1fc7))
* **indent-binary-ops:** remove unnecessary logic ([#645](https://github.com/eryue0220/eslint-stylistic/issues/645)) ([a06ed18](https://github.com/eryue0220/eslint-stylistic/commit/a06ed180b4b5a09d7bd0f2e06eff76b70f265546))
* **indent-binary-ops:** use unified testing tool ([#806](https://github.com/eryue0220/eslint-stylistic/issues/806)) ([3a8fc53](https://github.com/eryue0220/eslint-stylistic/commit/3a8fc53f5b05c23ecd0665c8ce4c2e6d5e94dd96))
* **indent:** add tests ([#428](https://github.com/eryue0220/eslint-stylistic/issues/428)) ([1334417](https://github.com/eryue0220/eslint-stylistic/commit/1334417307871bee72718c4d3056ac3e29d935e2))
* **indent:** simplify the code related to `PropertyDefinition` with decorators ([#489](https://github.com/eryue0220/eslint-stylistic/issues/489)) ([53d731f](https://github.com/eryue0220/eslint-stylistic/commit/53d731ff19ef25c8c4fbbab6db4b1f4a6270bdd2))
* make ts plugin self-contains ([#519](https://github.com/eryue0220/eslint-stylistic/issues/519)) ([7c7301e](https://github.com/eryue0220/eslint-stylistic/commit/7c7301e8f6844c833485542fc1eb3a1132d9c6c6))
* merge `block-spacing` ([#690](https://github.com/eryue0220/eslint-stylistic/issues/690)) ([b239b71](https://github.com/eryue0220/eslint-stylistic/commit/b239b717bb6dc9eb0632ce9d3bb3379501b72471))
* merge `brace-style` ([#715](https://github.com/eryue0220/eslint-stylistic/issues/715)) ([5769933](https://github.com/eryue0220/eslint-stylistic/commit/5769933da4c402fd54a59cfeb664f172c27948eb))
* merge `indent` ([#713](https://github.com/eryue0220/eslint-stylistic/issues/713)) ([a57c2bb](https://github.com/eryue0220/eslint-stylistic/commit/a57c2bb27226d5daf3098f09444ff91de2338084))
* merge `key-spacing` ([#734](https://github.com/eryue0220/eslint-stylistic/issues/734)) ([99c0873](https://github.com/eryue0220/eslint-stylistic/commit/99c0873f74464bff90f148efb8d4282a042956a0))
* merge `keyword-spacing` ([#732](https://github.com/eryue0220/eslint-stylistic/issues/732)) ([0018519](https://github.com/eryue0220/eslint-stylistic/commit/001851960ad5cf7e2490aa097655202dde2a80ba))
* merge `lines-around-comment` ([#691](https://github.com/eryue0220/eslint-stylistic/issues/691)) ([f59605b](https://github.com/eryue0220/eslint-stylistic/commit/f59605b9d1967357e9507998b0f7649c20094d55))
* merge `lines-between-class-members` ([#730](https://github.com/eryue0220/eslint-stylistic/issues/730)) ([9f4bda0](https://github.com/eryue0220/eslint-stylistic/commit/9f4bda0044d3ccb760eba65467a2062349c4409e))
* merge `no-extra-parens` ([#711](https://github.com/eryue0220/eslint-stylistic/issues/711)) ([d6809c9](https://github.com/eryue0220/eslint-stylistic/commit/d6809c910510a4477e01ea248071f0701d0af4ed))
* merge `no-extra-semi` ([#731](https://github.com/eryue0220/eslint-stylistic/issues/731)) ([880814e](https://github.com/eryue0220/eslint-stylistic/commit/880814e49fae4f25d1ff58204348427e65609714))
* merge `object-property-newline` ([#719](https://github.com/eryue0220/eslint-stylistic/issues/719)) ([d49ef91](https://github.com/eryue0220/eslint-stylistic/commit/d49ef91e765938c60e2b344391a0d5a09c85bdc1))
* merge `quote-props` ([#729](https://github.com/eryue0220/eslint-stylistic/issues/729)) ([e5b09a5](https://github.com/eryue0220/eslint-stylistic/commit/e5b09a52c1501295de96fa95e97b91d4ffeadddd))
* merge `quotes` ([#720](https://github.com/eryue0220/eslint-stylistic/issues/720)) ([9284830](https://github.com/eryue0220/eslint-stylistic/commit/9284830c2b816c66b8ae50bd4e0c0ecff1ad555e))
* merge `semi-spacing` ([#727](https://github.com/eryue0220/eslint-stylistic/issues/727)) ([72856a8](https://github.com/eryue0220/eslint-stylistic/commit/72856a876c64071cc68e9437562ec2422dfd39f6))
* merge `semi` ([#728](https://github.com/eryue0220/eslint-stylistic/issues/728)) ([85eeaa1](https://github.com/eryue0220/eslint-stylistic/commit/85eeaa16f102190f04801a8bfa9675f6638b51a4))
* merge `space-before-blocks` ([#698](https://github.com/eryue0220/eslint-stylistic/issues/698)) ([6e8554d](https://github.com/eryue0220/eslint-stylistic/commit/6e8554dbcb4dc87814c7131d3a235f3c68dee16e))
* merge `space-infix-ops` ([#697](https://github.com/eryue0220/eslint-stylistic/issues/697)) ([1a1b388](https://github.com/eryue0220/eslint-stylistic/commit/1a1b3886c42baeb15f113a8129256d1e0d9c23a6))
* merge object-curly-newline ([#717](https://github.com/eryue0220/eslint-stylistic/issues/717)) ([0d3e33b](https://github.com/eryue0220/eslint-stylistic/commit/0d3e33bda279dfc532efd4f6cafeb0b1881a3f9e))
* merge object-curly-spacing ([#718](https://github.com/eryue0220/eslint-stylistic/issues/718)) ([d943ef0](https://github.com/eryue0220/eslint-stylistic/commit/d943ef0c41a59ad361a2e14ea80058c3c0f9a2a6))
* move code into one package ([#497](https://github.com/eryue0220/eslint-stylistic/issues/497)) ([3a9535f](https://github.com/eryue0220/eslint-stylistic/commit/3a9535fd35367b3d8ae5e2d63616c2b080395d3c))
* move js utils out ([bc3a15d](https://github.com/eryue0220/eslint-stylistic/commit/bc3a15dbbfbcb7ffa7527c9275ad852703492848))
* move utils ([011f5fb](https://github.com/eryue0220/eslint-stylistic/commit/011f5fb1a8b555e6ee96ec26ca3ace37198a1e4e))
* move utils ([60ef2ba](https://github.com/eryue0220/eslint-stylistic/commit/60ef2ba54b2485bf9227b66fff826db96a7c31ba))
* **one-var-declaration-per-line:** use replace string insert `\n` ([#705](https://github.com/eryue0220/eslint-stylistic/issues/705)) ([48181b5](https://github.com/eryue0220/eslint-stylistic/commit/48181b51e4c7309b8efc73de7a993e709faa8770))
* **quotes:** add some test cases ([a7f7c2a](https://github.com/eryue0220/eslint-stylistic/commit/a7f7c2a900223570586740763487b674644560e2))
* release-please-mark ([4ead7ab](https://github.com/eryue0220/eslint-stylistic/commit/4ead7abf53b752d35db28e910e6fe31cd9913734))
* release-please-mark ([d99936f](https://github.com/eryue0220/eslint-stylistic/commit/d99936f4667ac2d8710db526e4dd7328aaccb396))
* release-please-mark ([4a689f1](https://github.com/eryue0220/eslint-stylistic/commit/4a689f178dc62de258580aa4267e9a134eefb8ea))
* release-please-mark ([b894a75](https://github.com/eryue0220/eslint-stylistic/commit/b894a75f8d38ab9af6ae419d69447a2de0ff337e))
* release-please-mark ([100a4fd](https://github.com/eryue0220/eslint-stylistic/commit/100a4fd52a097ba9487b43c5e4c3fff222094a1e))
* release-please-mark ([e9ca882](https://github.com/eryue0220/eslint-stylistic/commit/e9ca88292b0c137226dadfbfa77bf9d73584802b))
* release-please-mark ([ceff702](https://github.com/eryue0220/eslint-stylistic/commit/ceff702a78e6abc0f714714fedfab3100d2f5625))
* release-please-mark ([5e7a284](https://github.com/eryue0220/eslint-stylistic/commit/5e7a2841f226347c853559a58c3601d369b8a1ad))
* release-please-mark ([08b65a5](https://github.com/eryue0220/eslint-stylistic/commit/08b65a5a605f4e86808983275370271548e98ec9))
* release-please-mark ([34148f4](https://github.com/eryue0220/eslint-stylistic/commit/34148f41089bcdf9621a02bd62b28b3db94f56ac))
* release-please-mark ([4b2d7ba](https://github.com/eryue0220/eslint-stylistic/commit/4b2d7baa01258ef4ec0d92267950ec9a2ceee62e))
* release-please-mark ([1ed4f7f](https://github.com/eryue0220/eslint-stylistic/commit/1ed4f7f75faaf9b8e6d334f32505e5399b4702e1))
* release-please-mark ([96dd0e1](https://github.com/eryue0220/eslint-stylistic/commit/96dd0e1b66452387f4004e8a4c4ab3527fb04ebc))
* remove unnecessary ternary expression ([#695](https://github.com/eryue0220/eslint-stylistic/issues/695)) ([66a4b18](https://github.com/eryue0220/eslint-stylistic/commit/66a4b18d46979a1a51e350a0f547d28900a078dc))
* replace deprecated `isSpaceBetweenTokens` with `isSpaceBetween` ([#646](https://github.com/eryue0220/eslint-stylistic/issues/646)) ([6da7c42](https://github.com/eryue0220/eslint-stylistic/commit/6da7c42da0633ad9c8156910200c592cbe888a30))
* replace deprecated api with new api ([#567](https://github.com/eryue0220/eslint-stylistic/issues/567)) ([3db4870](https://github.com/eryue0220/eslint-stylistic/commit/3db4870f56b5f999439987eb904361488e764cc6))
* share utils folder ([deb8178](https://github.com/eryue0220/eslint-stylistic/commit/deb81783ca5132972b1da1fe2a91ad1d8ee4f8e3))
* **test:** replace the parsing result files with the real parser ([#505](https://github.com/eryue0220/eslint-stylistic/issues/505)) ([bd6f8bc](https://github.com/eryue0220/eslint-stylistic/commit/bd6f8bc19130e2bd4672b45abe1e180278f8535a))
* **type-generic-spacing:** unify spacing checks ([#800](https://github.com/eryue0220/eslint-stylistic/issues/800)) ([6f8b01c](https://github.com/eryue0220/eslint-stylistic/commit/6f8b01c550383d631d1da5d5e3919a29fb9a593b))
* unify createRule ([#507](https://github.com/eryue0220/eslint-stylistic/issues/507)) ([fc6e716](https://github.com/eryue0220/eslint-stylistic/commit/fc6e716f154f30c786288a97a4343c1bc594edab))
* use `RuleOptions` and `MessageIds` generic type ([#742](https://github.com/eryue0220/eslint-stylistic/issues/742)) ([ace84e3](https://github.com/eryue0220/eslint-stylistic/commit/ace84e3f15ec50443f250106aedbb5e38af4b5bd))
